      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 mb-5 mb-lg-0">
            <h4 class="mb-4">Desenvolvido Por :</h4>
            <p class="lead mb-0">
          ...
          <div class="col-lg-4">
            ...
            <p class="lead mb-0">A app Animalec usa tema de Bootstrap com licença MIT, gratuito e criado por <a href="http://startbootstrap.com" target="_blank">StartBootstrap</a>.</p>
          </div>
        </div>
      </div>
    </footer>
